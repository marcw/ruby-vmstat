module Vmstat
  ...
  class LinuxDisk < Disk
    ...
    # {LinuxDisk::FS_CODES}).
    # @param [Integer] fs the type or magix number of the disk.
    # @param [String] path the path to the disk
    # @param [Integer] block_size size of a file system block
    # @param [Integer] free_blocks the number of free blocks
    # @param [Integer] available_blocks the number of available blocks
